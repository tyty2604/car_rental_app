        ...
        children: [
          ...
          StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              int carCount = 0;
              if (snapshot.hasData) {
                carCount = snapshot.data!.docs.length;
              }
              ...
              return Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Số Lượng Xe Đã Đăng Ký: $carCount',
                    ...
                    const Icon(Icons.tornado_outlined, color: Colors.black38),
                  ],
                ),
              );
            },
                ...
                if (!snapshot.hasData) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String carname = snapshot.data!.docs[index]['make'].toString();
                      ...
                      if (searchcontroller.text.isEmpty) {
                        return Slidable(
                            ...
                            SlidableAction(
                              onPressed: (context) {
                                ref.doc(id).delete().then((value) {
                                  CustomToast().Toastt('Đã Xóa Xe Thành Công');
                          ...
                          child: Padding(
                            ...
                            child: DetailContainer(
                              ...
                              title:
                                  '${documentsnapshot['make'].toString()} ${documentsnapshot['model'].toString()}',
                              subtitle:
                        ...
                        return Padding(
                          ...
                          child: DetailContainer(
                            ...
                            text: '${documentsnapshot['price'].toString()}/Ngày',
                            title:
                                '${snapshot.data!.docs[index]['make'].toString()} ${snapshot.data!.docs[index]['model'].toString()}',
                            subtitle: snapshot.data!.docs[index]['category'].toString(),
                            ontap: () {},
                          ),
                        );
                      } else {
