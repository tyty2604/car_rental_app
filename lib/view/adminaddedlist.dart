...
class AdminAddedList extends StatefulWidget {
  const AdminAddedList({super.key});

  @override
  State<AdminAddedList> createState() => _AdminAddedListState();
}

class _AdminAddedListState extends State<AdminAddedList> {
...
StreamBuilder(
  stream: FirebaseFirestore.instance
      .collection("Cars")
      .where('addedBy', isEqualTo: "Quản Trị Viên") // Thay bằng giá trị cố định
      .snapshots(),
  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
    if (!snapshot.hasData) {
      ...
      return const Center(
        child: Text(
          '\n\n\n\n\n\n\n\n\nKhông có xe nào được thêm bởi Quản Trị Viên.',
